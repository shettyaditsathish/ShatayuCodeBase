package com.shatayu.command
{
	...
	public class DeletePatientCommand implements ICommand,IResponder
	{
		...
		public function execute( event : CairngormEvent ) : void
		{
			...
			patient = ShatayuEvent(event).dataLoad as Patient 
			arr.addItem(patient);
			delegate.deletePatient(arr);			
		}
		...
		{		
			...
			viewDataHolder.viewData["command"] = "deletePatient";
			viewDataHolder.viewData["commandData"] = patient;
