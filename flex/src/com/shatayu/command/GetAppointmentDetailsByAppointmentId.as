package com.shatayu.command
{
	...
	public class GetAppointmentDetailsByAppointmentId implements ICommand,IResponder
	{
		...
		public function execute( event : CairngormEvent ) : void
		{
			...
			delegate.getAppointmentsDetailsByAppointmentId(obj["appointmentId"] as String);			
		}
