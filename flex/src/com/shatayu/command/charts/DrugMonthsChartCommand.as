package com.shatayu.command.charts
{
	...
	public class DrugMonthsChartCommand implements ICommand,IResponder
	{
		...
		public function execute( event : CairngormEvent ) : void
		{
			...
			delegate.getMedicineUsageByList((obj["drugList"] as ArrayCollection),(obj["startDate"] as Date),(obj["endDate"] as Date));			
		}
